...
export default function ForgotPasswordScreen() {
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', padding: theme.spacing[4] }}>
      <Typography variant="body">Password reset isn&apos;t implemented yet.</Typography>
    </View>
  );
}
